let Joi,User;_c75‍.x([["register",()=>register],["login",()=>login],["check",()=>check],["logout",()=>logout],["authResult",()=>authResult]]);_c75‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_c75‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);// 회원 인증 API
...
var user_seq_no;
  ...
  axios
    ...
    .catch((err) => {
      _c75‍.g.console.log(err.response);
    });
};
