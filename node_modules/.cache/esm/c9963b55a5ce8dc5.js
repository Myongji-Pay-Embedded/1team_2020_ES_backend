let Membership,Joi,mongoose;_a5c‍.x([["getMemebershipById",()=>getMemebershipById],["add",()=>add],["list",()=>list],["count",()=>count],["read",()=>read],["remove",()=>remove],["update",()=>update]]);_a5c‍.w("../../models/membership",[["default",["Membership"],function(v){Membership=v}]]);_a5c‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_a5c‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);
...
// 해당 id로 멤버쉽을 찾은 후에 ctx.state에 넣어주기.
       const getMemebershipById = async (ctx, next) => {
  const { id } = ctx.params;
