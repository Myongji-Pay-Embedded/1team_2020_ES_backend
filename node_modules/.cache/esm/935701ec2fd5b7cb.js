let Joi,User;_2fd‍.x([["register",()=>register],["login",()=>login],["check",()=>check],["logout",()=>logout],["authResult",()=>authResult]]);_2fd‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_2fd‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);// 회원 인증 API
...
const qs = require('querystring');
  ...
  axios.post(url, qs.stringify(data), axiosConfig)
    .then(res => {
      _2fd‍.g.console.log(res.data);
    })
    .catch(err => {
      _2fd‍.g.console.log(err.response);
    });
};
