let Joi,User,mongoose,Card,Membership;_160‍.x([["checkObjectId",()=>checkObjectId],["authResult",()=>authResult],["isExist",()=>isExist],["register",()=>register],["login",()=>login],["checkappkpwd",()=>checkappkpwd],["checkpwd",()=>checkpwd],["update",()=>update],["check",()=>check],["logout",()=>logout],["remove",()=>remove],["count",()=>count]]);_160‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_160‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_160‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_160‍.w("../../models/card",[["default",["Card"],function(v){Card=v}]]);_160‍.w("../../models/membership",[["default",["Membership"],function(v){Membership=v}]]);// 회원 인증 API
...
var user_seq_no;
  ...
  axios
    ...
    .then((res) => {
      _160‍.g.console.log(res.data);
      access_token = res.data.access_token;
      refresh_token = res.data.refresh_token;
      user_seq_no = res.data.user_seq_no;
      _160‍.g.console.log(user_seq_no);
    })
    .catch((err) => {
      _160‍.g.console.log(err.response);
    });
};
...
*/
  ...
  _160‍.g.console.log(id, password);
  try {
    const user = await User.findById(id);
    _160‍.g.console.log(user);
    const valid = await user.checkPassword(password);
    // 잘못된 비밀번호
    if (!valid) {
      ctx.status = 401;
...
// 회원정보 수정 => 비밀번호 수정 및 앱 비밀번호 수정
  ...
  _160‍.g.console.log(AppPwd, password);
  try {
    ...
    _160‍.g.console.log(ctx.request.body);
...
//카드, 계좌, 멤버십 개수 조회 
  ...
  await axios
    ...
    .catch((err) => {
      if(err.response){
        _160‍.g.console.log(err.response.data);
        _160‍.g.console.log(err.response.status);
        _160‍.g.console.log(err.response.headers);
      }
      else if(err.request){
        _160‍.g.console.log(err.request);
      }
      else{
        _160‍.g.console.log("Error: ", err);
      }
      _160‍.g.console.log(err.config);
    });
