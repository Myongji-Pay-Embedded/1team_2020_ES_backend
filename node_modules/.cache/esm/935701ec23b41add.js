let Joi,User,mongoose;_23b‍.x([["checkObjectId",()=>checkObjectId],["authResult",()=>authResult],["isExist",()=>isExist],["register",()=>register],["login",()=>login],["checkappkpwd",()=>checkappkpwd],["checkpwd",()=>checkpwd],["update",()=>update],["check",()=>check],["logout",()=>logout],["remove",()=>remove]]);_23b‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_23b‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_23b‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);// 회원 인증 API
...
var user_seq_no;
  ...
  axios
    ...
    .then((res) => {
      _23b‍.g.console.log(res.data);
      access_token = res.data.access_token;
      refresh_token = res.data.refresh_token;
      user_seq_no = res.data.user_seq_no;
      _23b‍.g.console.log(user_seq_no);
    })
    .catch((err) => {
      _23b‍.g.console.log(err.response);
    });
};
...
*/
  ...
  _23b‍.g.console.log(id, password);
  try {
    const user = await User.findById(id);
    const valid = await user.checkPassword(password);
    // 잘못된 비밀번호
...
// 회원정보 수정 => 비밀번호 수정 및 앱 비밀번호 수정
  ...
  _23b‍.g.console.log(AppPwd, password);
  try {
    ...
    _23b‍.g.console.log(ctx.request.body);
