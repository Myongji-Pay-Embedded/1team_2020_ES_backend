let Joi,Account,User,mongoose,read;_6b3‍.x([["list",()=>list],["balance",()=>balance],["transactionList",()=>transactionList],["transfer",()=>transfer],["transactionAll",()=>transactionAll],["transactionGraph",()=>transactionGraph]]);_6b3‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_6b3‍.w("../../models/account",[["default",["Account"],function(v){Account=v}]]);_6b3‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_6b3‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);_6b3‍.w("../card/cards.ctrl",[["read",["read"],function(v){read=v}]]);// 계좌 인증 API
...
//계좌 목록 조회 (testapi에서 받아온 값을 바로 body로 전송)
  ...
  await axios
    .get(url, config)
    .then((res) => {
      _6b3‍.g.console.log(res.data);
      ctx.body = res.data.res_list;
    })
    .catch((err) => {
      if(err.response){
        _6b3‍.g.console.log(err.response.data);
        _6b3‍.g.console.log(err.response.status);
        _6b3‍.g.console.log(err.response.headers);
      }
      else if(err.request){
        _6b3‍.g.console.log(err.request);
      }
      else{
        _6b3‍.g.console.log("Error: ", err);
      }
      _6b3‍.g.console.log(err.config);
    });
};
...
//거래내역 조회
  ...
  _6b3‍.g.console.log(fintech_use_num);
  ...
  await axios
    ...
    .catch((err) => {
      _6b3‍.g.console.log(err.response);
    });
};
