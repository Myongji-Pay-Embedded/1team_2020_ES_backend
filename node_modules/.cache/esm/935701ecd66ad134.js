let Joi,User,mongoose;_d66‍.x([["checkObjectId",()=>checkObjectId],["authResult",()=>authResult],["isExist",()=>isExist],["register",()=>register],["login",()=>login],["checkappkpwd",()=>checkappkpwd],["checkpwd",()=>checkpwd],["update",()=>update],["check",()=>check],["logout",()=>logout],["remove",()=>remove]]);_d66‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_d66‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_d66‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);// 회원 인증 API
...
var user_seq_no;
  ...
  axios
    ...
    .then((res) => {
      _d66‍.g.console.log(res.data);
      access_token = res.data.access_token;
      refresh_token = res.data.refresh_token;
      user_seq_no = res.data.user_seq_no;
      _d66‍.g.console.log(user_seq_no);
    })
    .catch((err) => {
      _d66‍.g.console.log(err.response);
    });
};
...
*/
  ...
  _d66‍.g.console.log(id, password);
  try {
    const user = await User.findById(id);
    _d66‍.g.console.log(user);
    const valid = await user.checkPassword(password);
    // 잘못된 비밀번호
    if (!valid) {
      ctx.status = 401;
...
// 회원정보 수정 => 비밀번호 수정 및 앱 비밀번호 수정
  ...
  _d66‍.g.console.log(AppPwd, password);
  try {
    ...
    _d66‍.g.console.log(ctx.request.body);
