let mongoose,Schema,bcrypt;_886‍.x([["default",()=>_886‍.o]]);_886‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}],["Schema",["Schema"],function(v){Schema=v}]]);_886‍.w("bcryptjs",[["default",["bcrypt"],function(v){bcrypt=v}]]);// 사용자 카드 정보 스키마



const CardSchema = new Schema({
  bank: String, // 은행이름
  cardNumber_d: String, // 사용자 카드번호 앞 4자리
  hashedcardNumber: String, // 사용자 카드번호 뒷 12자리,
  cardColor: String,
  validity: String, //유효기간 MMYY,
