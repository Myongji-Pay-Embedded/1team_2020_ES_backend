let Joi,User,mongoose;_bcb‍.x([["checkObjectId",()=>checkObjectId],["authResult",()=>authResult],["register",()=>register],["isExist",()=>isExist],["login",()=>login],["update",()=>update],["check",()=>check],["logout",()=>logout]]);_bcb‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_bcb‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_bcb‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);// 회원 인증 API
...
var user_seq_no;
  ...
  axios
    ...
    .then((res) => {
      _bcb‍.g.console.log(res.data);
      access_token = res.data.access_token;
      refresh_token = res.data.refresh_token;
      user_seq_no = res.data.user_seq_no;
      _bcb‍.g.console.log(user_seq_no);
    })
    .catch((err) => {
      _bcb‍.g.console.log(err.response);
    });
};
...
*/
  ...
  _bcb‍.g.console.log("Check " + userId + "is exitst");
  //
