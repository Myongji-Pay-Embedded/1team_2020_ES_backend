let Joi,User,mongoose;_cb7‍.x([["checkObjectId",()=>checkObjectId],["authResult",()=>authResult],["isExist",()=>isExist],["register",()=>register],["login",()=>login],["checkappkpwd",()=>checkappkpwd],["checkpwd",()=>checkpwd],["update",()=>update],["check",()=>check],["logout",()=>logout]]);_cb7‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_cb7‍.w("../../models/user",[["default",["User"],function(v){User=v}]]);_cb7‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);// 회원 인증 API
...
var user_seq_no;
  ...
  axios
    ...
    .then((res) => {
      _cb7‍.g.console.log(res.data);
      access_token = res.data.access_token;
      refresh_token = res.data.refresh_token;
      user_seq_no = res.data.user_seq_no;
      _cb7‍.g.console.log(user_seq_no);
    })
    .catch((err) => {
      _cb7‍.g.console.log(err.response);
    });
};
...
*/
  ...
  _cb7‍.g.console.log(id, password);
  try {
    const user = await User.findById(id);
    const valid = await user.checkPassword(password);
    // 잘못된 비밀번호
...
// 회원정보 수정 => 비밀번호 수정 및 앱 비밀번호 수정
  ...
  _cb7‍.g.console.log(AppPwd, password);
  try {
    ...
    _cb7‍.g.console.log(ctx.request.body);
