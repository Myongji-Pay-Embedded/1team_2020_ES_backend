let Router,membershipCtrl,checkLoggedIn;_de8‍.x([["default",()=>_de8‍.o]]);_de8‍.w("koa-router",[["default",["Router"],function(v){Router=v}]]);_de8‍.w("./membership.ctrl",[["*",null,function(v){membershipCtrl=v}]]);_de8‍.w("../../lib/checkLoggedIn",[["default",["checkLoggedIn"],function(v){checkLoggedIn=v}]]);// 5개의 라우터
...
memberships.get('/count', checkLoggedIn, membershipCtrl.count); // 사용자의 모든 멤버쉽 개수 조회
